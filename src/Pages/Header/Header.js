...
const Header = () => {
    ...
    return (
        <div>
            <Navbar  className=" pt-0 overflow-hidden" collapseOnSelect expand="lg" bg="light" variant="light" >
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <Nav.Link href="/booking" className=" text-black fw-bold fw-2">Book Appointment</Nav.Link>
                        </Nav>
                        <Nav>
                            ...
                            {user.email ?
                                ...
                                <>
                                    <p className="mt-3">Hello, { user?.displayName || user?.email }</p>
